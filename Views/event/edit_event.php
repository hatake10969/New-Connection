    ...
    <div id=bgimg>
      <div id="contents_wrapper">
        ...
        <form action="" method="post" id="create_form" enctype="multipart/form-data">
          ...
          <input type="text" class="content content_border" name="name" value="<?= $event_info["name"]; ?>">
          ...
          <textarea name="content" rows="10" class="content content_border"><?= $event_info["content"]; ?></textarea>
          ...
          <input type="text" class="content content_border" name="place" value="<?= $event_info["place"]; ?>">
          ...
          <input type="date" class="content_border" id="date" name="date" value="<?= $event_info["date"]; ?>">
          ...
          <input type="time" class="content_border" name="time" value="<?= $event_info["time"]; ?>">
