    ...
    <div id=bgimg>
      ...
      <h1><span>作成したイベント一覧</span></h1>
        <?php if($result): ?>
          ...
          <?php endforeach ?>
        <?php else: ?>
          <div id='no_search'><h1>※ まだイベントを作成していません ※</h1></div>
          <div id="not_created"><a href="/event/create.php?id=<?php echo $_SESSION['user']['id']; ?>" id="first_event">イベントを作成する</a></div>
        <?php endif ?>
